...
function Dashboard() {
    ...
    const cardsData = [
        ...
        { id: 7, md: 3, xs: 5, title: 'Member Listing', borderRadius: '10px', borderColor: '#8ab9e6', description: 'Name/Flat/Dues', navigateTo: RouteConstants.MEMBERS_LIST, height: '200px' }
    ];
